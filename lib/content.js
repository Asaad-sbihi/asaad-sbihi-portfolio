...
export const PROJECTS = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      intro:
        "A complete visual strategy for Walili Immobilier and its in-house creative arm, W Agency — built to position the brand at the premium tier of the Moroccan real-estate market. The direction is deliberately restrained: disciplined grids, generous negative space, and a gold-on-charcoal palette that signals value without shouting. Every touchpoint, from a single listing to a full campaign, is engineered to read as one confident brand.",
      role: "Brand Identity • Visual Strategy • Panoramic Carousels • Motion Design",
      sections: [
        {
          heading: "Graphic & Branding Services",
          body:
            "Delivered the day-to-day content system end to end — modular post layouts, panoramic multi-slide carousels for property walkthroughs, and a gold accent palette applied with intent rather than ornament. The engagement also produced a full custom branding kit: logo lock-ups, a typographic scale, iconography, and templated frames that let the marketing team ship on-brand collateral at speed, with zero drift.",
        },
      ],
      video: {
        ...
        note:
          "A high-gloss promotional reel produced start to finish — edit, motion typography, transitions, sound design, and colour grade. Cut for the feed: vertical, front-loaded, and legible with the sound off. Kinetic text and gold light accents carry the brand system into motion, turning a property tour into a few seconds of premium film.",
      },
